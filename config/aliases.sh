...
alias tryhackme='sudo openvpn ~/Vpn/R3dM0nkey_thm.ovpn'
alias hackthebox='sudo openvpn ~/Vpn/R3dM0nkey_htb.ovpn'
...
alias msfstart='systemctl start postgresql && msfconsole'
